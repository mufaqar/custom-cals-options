jQuery(document).ready(function ($) {
  ...
  function updatePrice() {
    ...
    console.log("Electric System Price:", electricSystem === 'yes' ? electricSystemPrice : 0);
  ...
  $('#custom_height_feet, #custom_height_inches').on('input change', function () {
    updatePrice(); // Update price when height changes
  });
